...
Declare_Any_Class( "Bee_Scene",  // An example of drawing a hierarchical object using a "model_transform" matrix and post-multiplication.
  { 'construct'( context )
    ...
    'draw_leg'(graphics_state, model_transform, index)
    {
      var c;
      if (index == 0)
        c = 1;
      ...
      model_transform = mult( model_transform, translation( 0, -0.5, c*0.5 ) );
      model_transform = mult( model_transform, rotation( (Math.sin(graphics_state.animation_time/1000)-1)*15, (-1)*c, 0, 0) );
      model_transform = mult( model_transform, translation( 0, 0.5, (-0.5)*c ) );
      model_transform = mult( model_transform, translation( 0, -0.5, c*0.5 ) );
                
                
      model_transform = mult( model_transform, translation( 0, -0.5, c*0.125 ) );
      model_transform = mult( model_transform, scale( 0.125, 0.5, 0.125 ) );
      this.shapes.box       .draw( graphics_state, model_transform,                      this.greyPlastic );
      model_transform = mult( model_transform, scale( 8, 2, 8 ) );
      model_transform = mult( model_transform, translation( 0, -0.5, c*(-0.125) ) );
      model_transform = mult( model_transform, rotation( 10*(Math.sin(graphics_state.animation_time/1000)-1), c*(-1), 0, 0) );
      model_transform = mult( model_transform, translation( 0, -0.5, c*0.125 ) );
      model_transform = mult( model_transform, scale( 0.125, 0.5, 0.125 ) );
      this.shapes.box       .draw( graphics_state, model_transform,                      this.greyPlastic );
    },
    ...
    'display'( graphics_state )
      { 
         var model_transform = identity();
                ...
                model_transform = mult( model_transform, translation( 0, -30.8, 0 ) );
                model_transform = mult( model_transform, scale( 30, 30, 30 ) );
                this.shapes.box       .draw( graphics_state, model_transform,                      this.yellow_clay );
                model_transform = mult( model_transform, scale( 1/30, 1/30, 1/30 ) );
                model_transform = mult( model_transform, translation( 0, 30.8, 0 ) );

                //flower
                model_transform = mult( model_transform, scale( 0.3, 0.8, 0.3 ) );
                this.shapes.box       .draw( graphics_state, model_transform,                      this.brown_clay );
                model_transform = mult( model_transform, scale( 1/.3, 1/0.8, 1/.3 ) );
                for(var i=0; i<7; i++)
                {
                   model_transform = mult( model_transform, translation( 0, 0.8, 0 ) );
                   model_transform = mult( model_transform, rotation( Math.sin(graphics_state.animation_time/2000)*5, 0, 0, 1 ) );
                   model_transform = mult( model_transform, translation( 0, 0.8, 0 ) );
                   model_transform = mult( model_transform, scale( 0.3, 0.8, 0.3 ) );
                   this.shapes.box       .draw( graphics_state, model_transform,                      this.brown_clay );
                   model_transform = mult( model_transform, scale( 1/.3, 1/0.8, 1/.3 ) );
                ...
                model_transform = mult( model_transform, translation( 0, 0, -7 ) );
                model_transform = mult( model_transform, rotation(graphics_state.animation_time/2000*36, 0, -1, 0 ) );
                model_transform = mult( model_transform, translation( 0, Math.sin(graphics_state.animation_time/2000)*2, 0 ) );
                model_transform = mult( model_transform, translation( 0, 0, 7 ) );
                ...
                model_transform = mult( model_transform, scale( 2, 2, 2 ) );
                model_transform = mult( model_transform, translation( 1.5, 0, 0 ) );
                model_transform = mult( model_transform, scale( 2, .8, .8 ) );
                model_transform = mult( model_transform, translation( 1.5, 0, 0 ) );
                this.shapes.ball       .draw( graphics_state, model_transform,                      this.blueGlass );
                model_transform = mult( model_transform, translation( -1.5, 0, 0 ) );
                model_transform = mult( model_transform, scale( .5, 1/.8, 1/.8 ) );
                
                //wings
                var temp = model_transform;
                model_transform = mult( model_transform, translation( 0, 0.5, 0.5 ) );
                model_transform = mult( model_transform, rotation( Math.sin(graphics_state.animation_time/1000)*50, -1, 0, 0) );
                model_transform = mult( model_transform, translation( 0, -0.5, -0.5 ) );

                model_transform = mult( model_transform, translation( 0, 0.55, 2 ) );
                model_transform = mult( model_transform, scale( .5, 1/20, 1.5 ) );
                this.shapes.box       .draw( graphics_state, model_transform,                      this.brown_clay );
                model_transform = mult( model_transform, scale( 2, 20, 1/1.5 ) );
                model_transform = mult( model_transform, translation( 0, -0.55, -2 ) );
                ...
                //legs
                this.draw_leg( graphics_state, model_transform, 0);
                model_transform = temp;
                this.draw_leg( graphics_state, model_transform, 1);
                model_transform = temp;
                ...
                /*model_transform = mult( model_transform, translation( 0, -0.5, 0.5 ) );
                model_transform = mult( model_transform, rotation( (Math.cos(graphics_state.animation_time/1000)-1)*15, -1, 0, 0) );
                model_transform = mult( model_transform, translation( 0, 0.5, -0.5 ) );
                model_transform = mult( model_transform, translation( 0, -0.5, 0.5 ) );
                
                //model_transform = mult( model_transform, rotation(30, -1, 0, 0) );
                model_transform = mult( model_transform, translation( 0, -0.5, 0.125 ) );
                model_transform = mult( model_transform, scale( 0.125, 0.5, 0.125 ) );
                this.shapes.box       .draw( graphics_state, model_transform,                      this.brown_clay );
                model_transform = mult( model_transform, scale( 8, 2, 8 ) );
                model_transform = mult( model_transform, translation( 0, -0.5, -0.125 ) );
                model_transform = mult( model_transform, rotation( 10*(Math.cos(graphics_state.animation_time/1000)-1), -1, 0, 0) );
                model_transform = mult( model_transform, translation( 0, -0.5, 0.125 ) );
                model_transform = mult( model_transform, scale( 0.125, 0.5, 0.125 ) );
                this.shapes.box       .draw( graphics_state, model_transform,                      this.brown_clay );*/
